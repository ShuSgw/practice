...
const config = {
  apiKey: process.env.REACT_APP_APA_KEY_TODO,
  authDomain: process.env.REACT_APP_AUTH_DOMAIN_TODO,
  databaseURL: process.env.REACT_APP_DATABASE_URL_TODO,
  projectId: process.env.REACT_APP_PROJECT_ID_TODO,
  storageBucket: process.env.REACT_APP_STORAGE_BUCKET_TODO,
  messagingSenderId: process.env.REACT_APP_MESSAGING_SENDER_ID_TODO,
  appId: process.env.REACT_APP_ID_TODO
};
